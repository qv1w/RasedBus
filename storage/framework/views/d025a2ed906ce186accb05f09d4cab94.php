...
<?php $__env->startSection('title', 'عرض التقرير - ' . $report->report_number); ?>
...
<div class="d-flex justify-content-between align-items-center w-100 no-print">
    <div>
        ...
        <p class="text-light opacity-75 mb-0">
            رقم التقرير: <?php echo e($report->report_number); ?> | 
...
<div id="report-container">
    ...
    <div class="alert alert-info no-print mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <small>
                    تم إنشاء هذا التقرير بتاريخ <strong><?php echo e($generatedAt); ?></strong>
                    <?php if($report->notes): ?>
                    | ملاحظات: <?php echo e($report->notes); ?>
    ...
    <div class="print-header-section">
        ...
        <div class="print-date">
            <span><?php echo e($report->title); ?></span>
            <span>رقم: <?php echo e($report->report_number); ?></span>
            <span>تاريخ الإنشاء: <?php echo e($generatedAt); ?></span>
        </div>
    </div>
    ...
    <div class="report-footer">
        <p>تقرير مؤرشف رقم: <strong><?php echo e($report->report_number); ?></strong></p>
        <p>تاريخ البيانات: <strong><?php echo e($generatedAt); ?></strong></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rasedbus/project-bus/resources/views/admin/reports/show.blade.php ENDPATH**/ ?>