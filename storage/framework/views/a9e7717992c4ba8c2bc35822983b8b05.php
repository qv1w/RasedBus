...
unset($__errorArgs, $__bag); ?>"
                               ...
                               placeholder="مثال: Toyota Coaster 2023">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('capacity', 30)); ?>"
                               min="1"
                               max="100"
                               required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="center_id" 
                                class="form-select <?php $__errorArgs = ['center_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__currentLoopData = $centers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $center): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <?php echo e(old('center_id') == $center->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="driver_id" 
                                class="form-select <?php $__errorArgs = ['driver_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-bus\resources\views/admin/buses/create.blade.php ENDPATH**/ ?>