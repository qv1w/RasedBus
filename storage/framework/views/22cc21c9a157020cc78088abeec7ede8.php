            ...
            <form method="POST" action="<?php echo e(route('student.register.submit')); ?>" id="studentForm">
                ...
                <div class="mb-3">
                    <div class="d-flex gap-2 mb-2 flex-wrap">
                        <button type="button" class="btn btn-outline-light btn-sm" onclick="getCurrentLocation()">
...
<?php /**PATH C:\xampp\htdocs\project-bus\resources\views/student/create.blade.php ENDPATH**/ ?>