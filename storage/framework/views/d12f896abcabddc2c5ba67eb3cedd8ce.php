...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'لوحة التحكم'); ?> - نظام النقل</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('admin.students.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.students.*') ? 'active' : ''); ?>">
                    ...
                    <?php if($pendingCount > 0): ?>
                        <span class="nav-badge"><?php echo e($pendingCount); ?></span>
                    <?php endif; ?>
                </a>
            </div>
            <div class="nav-item">
                <a href="<?php echo e(route('admin.buses.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.buses.*') ? 'active' : ''); ?>">
                    <i class="fas fa-bus"></i>
                    <span>الباصات</span>
                </a>
            </div>
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('admin.centers.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.centers.*') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\project-bus\resources\views/layouts/admin.blade.php ENDPATH**/ ?>