<?php $__env->startSection('title', 'إنشاء دفعات جماعية'); ?>
...
<div class="d-flex justify-content-between align-items-center w-100">
    ...
    <a href="<?php echo e(url('admin/payments')); ?>" class="btn btn-outline-light">
...
<form action="<?php echo e(url('admin/payments/bulk-store')); ?>" method="POST" id="bulkPaymentForm">
    <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-7 mb-4">
            <div class="content-card">
                    ...
                    <div class="group-header bg-dar-light mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <span class="badge bg-dar ms-2"><?php echo e($darCenters->count()); ?></span>
                            </div>
                            <small class="text-muted"><?php echo e($darCenters->sum('students_count')); ?> طالب</small>
                        </div>
                    </div>
                    
                    <div class="row">
                        <?php $__currentLoopData = $darCenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $center): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 mb-2">
                            <label class="center-checkbox-card" data-type="دار">
                                <input type="checkbox" name="center_ids[]" value="<?php echo e($center->id); ?>" 
                                       class="center-checkbox" data-students="<?php echo e($center->students_count); ?>">
                                <div class="card-content">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="fw-bold"><?php echo e($center->center_name); ?></div>
                                            <small class="text-muted">
                                                <i class="fas fa-users me-1"></i>
                                                <?php echo e($center->students_count); ?> طالب
                                            </small>
                                        </div>
                    ...
                    <div class="group-header bg-markaz-light mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <span class="badge bg-markaz ms-2"><?php echo e($markazCenters->count()); ?></span>
                            </div>
                            <small class="text-muted"><?php echo e($markazCenters->sum('students_count')); ?> طالب</small>
                        </div>
                    </div>
                    
                    <div class="row">
                        <?php $__currentLoopData = $markazCenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $center): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 mb-2">
                    ...
                    <div class="group-header bg-program-light mb-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <span class="badge bg-program ms-2"><?php echo e($programCenters->count()); ?></span>
                            </div>
                            <small class="text-muted"><?php echo e($programCenters->sum('students_count')); ?> طالب</small>
                        </div>
                    </div>
                    
                    <div class="row">
                        <?php $__currentLoopData = $programCenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $center): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 mb-2">
                ...
                <div class="text-center py-5">
                    ...
                    <a href="<?php echo e(url('admin/centers/create')); ?>" class="btn btn-success mt-3">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group input-group-lg">
                        <input type="number" name="amount" class="form-control" 
                               value="<?php echo e(old('amount')); ?>" step="0.01" min="1" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="description" class="form-control" 
                           value="<?php echo e(old('description', 'رسوم النقل - ' . date('Y'))); ?>"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="notes" class="form-control" rows="2" 
                              placeholder="ملاحظات داخلية..."><?php echo e(old('notes')); ?></textarea>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-bus\resources\views/admin/payments/bulk-create.blade.php ENDPATH**/ ?>