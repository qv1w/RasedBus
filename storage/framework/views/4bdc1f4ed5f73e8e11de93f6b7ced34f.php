<?php $__env->startSection('title', 'تفاصيل المركز - ' . $center->center_name); ?>
    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('admin.centers.index')); ?>">المراكز</a></li>
                <li class="breadcrumb-item active"><?php echo e($center->center_name); ?></li>
            </ol>
        </nav>
    </div>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('admin.centers.edit', $center)); ?>" class="btn btn-warning">
            <i class="fas fa-edit me-1"></i>
            تعديل
        </a>
        <a href="<?php echo e(route('admin.centers.index')); ?>" class="btn btn-outline-light">
...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <div class="content-card text-center mb-4">
            ...
            <h4 class="mb-1"><?php echo e($center->center_name); ?></h4>
            <p class="text-muted mb-3"><?php echo e($center->address ?: 'العنوان غير محدد'); ?></p>
            
            <span class="badge bg-<?php echo e($center->status == 'active' ? 'success' : 'secondary'); ?> fs-6 px-3 py-2">
                <?php echo e($center->status == 'active' ? 'نشط' : 'غير نشط'); ?>
        ...
        <div class="content-card">
            ...
            <div class="row text-center">
                <div class="col-4 mb-3">
                    <h3 class="text-primary mb-0"><?php echo e($studentsCount); ?></h3>
                    <small class="text-muted">طالبة</small>
                </div>
                <div class="col-4 mb-3">
                    <h3 class="text-warning mb-0"><?php echo e($busesCount); ?></h3>
                    <small class="text-muted">باص</small>
                </div>
                <div class="col-4 mb-3">
                    <h3 class="text-success mb-0"><?php echo e($driversCount); ?></h3>
    ...
    <div class="col-lg-8">
        ...
        <div class="content-card mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="schedule-card <?php echo e($center->morning_available ? 'active' : 'inactive'); ?>">
                        ...
                        <div class="schedule-body">
                            <div class="time-range">
                                ...
                                <span class="time-value"><?php echo e($center->morning_start ?? '08:00'); ?></span>
                                <span class="time-label">إلى</span>
                                <span class="time-value"><?php echo e($center->morning_end ?? '12:00'); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                ...
                <!-- الفترة المسائية -->
                <div class="col-md-6 mb-3">
                    <div class="schedule-card <?php echo e($center->evening_available ? 'active' : 'inactive'); ?>">
                        <div class="schedule-header">
                        ...
                        <div class="schedule-body">
                            <div class="time-range">
                                <span class="time-label">من</span>
                                <span class="time-value"><?php echo e($center->evening_start ?? '16:00'); ?></span>
                                <span class="time-label">إلى</span>
                                <span class="time-value"><?php echo e($center->evening_end ?? '20:00'); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
        ...
        <div class="content-card mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="coverage-card morning">
                        ...
                        <?php if($morningCoverage && count($morningCoverage) > 0): ?>
                            <div class="coverage-info">
                                <span class="badge bg-success mb-2">
                                    <i class="fas fa-check me-1"></i>
                                    محدد (<?php echo e(count($morningCoverage)); ?> نقطة)
                                </span>
                ...
                <div class="col-md-6 mb-3">
                    <div class="coverage-card evening">
                        ...
                        <?php if($eveningCoverage && count($eveningCoverage) > 0): ?>
                            <div class="coverage-info">
                                <span class="badge bg-success mb-2">
                                    <i class="fas fa-check me-1"></i>
                                    محدد (<?php echo e(count($eveningCoverage)); ?> نقطة)
                                </span>
            ...
            <!-- خريطة شاملة -->
            <?php if(($morningCoverage && count($morningCoverage) > 0) || ($eveningCoverage && count($eveningCoverage) > 0)): ?>
            <div class="mt-4">
                <h6 class="mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="detail-item">
                        ...
                        <span class="detail-value"><?php echo e($center->created_at->format('Y/m/d H:i')); ?></span>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="detail-item">
                        <span class="detail-label">آخر تحديث</span>
                        <span class="detail-value"><?php echo e($center->updated_at->format('Y/m/d H:i')); ?></span>
                    </div>
                </div>
                <?php if($center->notes): ?>
                <div class="col-12">
                    <div class="detail-item">
                        ...
                        <span class="detail-value"><?php echo e($center->notes); ?></span>
                    </div>
                </div>
                <?php endif; ?>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const morningCoverage = <?php echo json_encode($morningCoverage ?? [], 15, 512) ?>;
    const eveningCoverage = <?php echo json_encode($eveningCoverage ?? [], 15, 512) ?>;
    ...
    if ((morningCoverage && morningCoverage.length > 0) || (eveningCoverage && eveningCoverage.length > 0)) {
        ...
        L.marker(zulfiCenter).addTo(fullMap)
            .bindPopup('<strong><?php echo e($center->center_name); ?></strong>')
            .openPopup();
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-bus\resources\views/admin/centers/show.blade.php ENDPATH**/ ?>