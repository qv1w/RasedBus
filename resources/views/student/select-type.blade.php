...
<body>
    <div class="container">
        ...
        <div class="row g-4">
            <!-- دور التحفيظ -->
            <div class="col-md-6">
                <a href="{{ route('student.register.form', ['type' => 'دار', 'gender' => 'بنات']) }}" class="registration-card">
                    <div class="icon">
            ...
            <!-- مركز إعداد المعلمات -->
            <div class="col-md-6">
                <a href="{{ route('student.register.form', ['type' => 'مركز', 'gender' => 'بنات']) }}" class="registration-card">
                    <div class="icon">
        ...
        <div class="riyaheen-section">
            ...
            <div class="riyaheen-cards">
                ...
                <a href="{{ route('student.register.form', ['type' => 'برنامج', 'gender' => 'بنين']) }}" class="riyaheen-card male">
                    <div class="icon">
                ...
                <a href="{{ route('student.register.form', ['type' => 'برنامج', 'gender' => 'بنات']) }}" class="riyaheen-card female">
                    <div class="icon">
                        <i class="fas fa-child"></i>
                    </div>
