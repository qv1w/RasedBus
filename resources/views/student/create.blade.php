...
<head>
    ...
    <title>{{ $pageTitle ?? 'تسجيل جديد' }} - جمعية القرآن الكريم للزلفي</title>
...
<body>
    <div class="container">
        <a href="{{ route('student.register') }}" class="back-link">
        ...
        <div class="card">
            ...
            <div class="text-center">
                <span class="info-badge {{ $gender == 'بنات' ? 'female' : 'male' }}">
                    <i class="fas fa-{{ $gender == 'بنات' ? 'female' : 'male' }} me-1"></i>
                    {{ $gender }}
                </span>
            </div>
            @endif
            ...
            <form method="POST" action="{{ route('student.register.submit') }}" id="studentForm">
                @csrf

                <!-- حقول مخفية -->
                <input type="hidden" name="gender" value="{{ $gender == 'بنين' ? 'ذكر' : 'أنثى' }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="national_id" name="national_id" 
                                   value="{{ old('national_id') }}" required maxlength="10"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="guardian_mobile" name="guardian_mobile" 
                                   value="{{ old('guardian_mobile') }}" required maxlength="10"
                                   placeholder="05XXXXXXXX" inputmode="numeric">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="preferred_schedule" name="preferred_schedule" required>
                                    ...
                                    <option value="صباحية" {{ old('preferred_schedule') == 'صباحية' ? 'selected' : '' }}>صباحية</option>
                                    <option value="مسائية" {{ old('preferred_schedule') == 'مسائية' ? 'selected' : '' }}>مسائية</option>
                                </select>
                            </div>
                        </div>
                    @endif

                    <div class="col-md-{{ $type == 'دار' ? '6' : '12' }}">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="center_id" name="center_id" required>
                                ...
                                @if($type == 'مركز' || $type == 'برنامج')
                                    @foreach($centers as $center)
                                        <option value="{{ $center->id }}" {{ old('center_id') == $center->id ? 'selected' : '' }}>
                                            @if($type == 'برنامج')
                                                {{ str_contains($center->center_name, 'السيح') ? 'حي السيح' : 'حي الملك سلمان' }}
                                            @else
                                                {{ $center->center_name }}
                                            @endif
                                        </option>
