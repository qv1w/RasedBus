...
<head>
    ...
    <title>ملفي الشخصي - {{ $student->name }}</title>
...
<body>
                ...
                <div class="profile-card">
                    <div class="profile-header">
                        ...
                        <div class="status-badge status-{{ $statusClass }}">
                            <i class="fas fa-{{ $statusClass == 'approved' ? 'check-circle' : ($statusClass == 'pending' ? 'clock' : 'times-circle') }} me-1"></i>
                            {{ $statusText }}
                        </div>
                    </div>
                    ...
                    <div class="profile-body">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="info-card">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="info-value"><a href="tel:{{ $student->mobile }}">{{ $student->mobile }}</a></span>
                                    </div>
                                    <div class="info-item">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="info-value"><a href="tel:{{ $student->guardian_mobile }}">{{ $student->guardian_mobile }}</a></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-card">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="info-value">
                                            @if($student->center)
                                                <span class="badge bg-info">{{ $student->center->center_name }}</span>
                                            @else
                                                غير محدد
                                            @endif
                                        </span>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="info-value">
                                            <span class="badge bg-{{ $student->preferred_schedule == 'صباحية' ? 'warning text-dark' : 'secondary' }}">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="info-card">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span class="info-value">{{ $bus->driver->name }}</span>
                                    </div>
                                    <div class="info-item">
                                        <span class="info-label">جوال السائق</span>
                                        <span class="info-value"><a href="tel:{{ $bus->driver->mobile }}">{{ $bus->driver->mobile }}</a></span>
                                    </div>
                                    @endif
                                    @if($student->pickup_time)
                                    <div class="info-item">
                                        <span class="info-label">وقت الالتقاء</span>
                                        <span class="info-value">{{ $student->pickup_time }}</span>
                                    </div>
                                    @endif
                                    @else
                                ...
                                <div class="info-card">
                                    ...
                                    <div class="payment-summary">
                                        <div class="payment-box total">
                                            <span class="amount">{{ number_format($totalFees) }}</span>
                                            <span class="label">المطلوب</span>
                                        </div>
                                        <div class="payment-box paid">
                                            <span class="amount">{{ number_format($paidAmount) }}</span>
                                            <span class="label">المدفوع</span>
                                        </div>
                                        <div class="payment-box remaining">
                                            <span class="amount">{{ number_format($remainingAmount) }}</span>
                                    ...
                                    <a href="{{ route('student.payments') }}" class="btn btn-payments w-100 mt-3">
                        ...
                        <div class="text-center mt-4">
                            <div class="d-flex justify-content-center gap-3 flex-wrap">
                                @if($student->status === 'approved')
                                <a href="{{ route('student.payments') }}" class="btn btn-payments">
                                    <i class="fas fa-credit-card me-2"></i>
                                    الدفعات
                                </a>
                                @endif
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            @if($student->latitude && $student->longitude)
            const map = L.map('studentMap').setView([{{ $student->latitude }}, {{ $student->longitude }}], 16);
            L.tileLayer('https://mt1.google.com/vt/lyrs=y&x={x}&y={y}&z={z}', {
                maxZoom: 20,
                attribution: '© Google'
            }).addTo(map);
            
            L.marker([{{ $student->latitude }}, {{ $student->longitude }}]).addTo(map)
