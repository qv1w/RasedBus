    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('images/logo.png') }}" alt="الشعار" class="navbar-logo">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="navbar-nav navbar-cta gap-2">
                    <a class="nav-link btn-admin" href="{{ route('student.login') }}">
                        <i class="fas fa-sign-in-alt me-1"></i> دخول
                    </a>
                    <a class="nav-link btn-admin" href="{{ route('admin.login') }}">
    ...
    <section class="hero-section text-center">
        ...
        <div class="container">
            <div class="hero-content">
                <img src="{{ asset('images/logo.png') }}" alt="شعار الجمعية" class="hero-logo" data-aos="zoom-in" data-aos-duration="900">
                ...
                <div class="hero-buttons" data-aos="fade-up" data-aos-delay="650">
                    <a href="{{ route('student.register') }}" class="btn btn-hero btn-hero-primary">
                        <i class="fas fa-user-plus"></i> تسجيل جديد
                    </a>
                    <a href="{{ route('student.login') }}" class="btn btn-hero btn-hero-outline">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <a href="{{ route('student.register.form', ['type' => 'دار', 'gender' => 'بنات']) }}" class="program-card">
                        <div class="program-icon bg-gradient-dour">
                            <i class="fas fa-mosque"></i>
                        </div>
                        <h5>دور تحفيظ القرآن الكريم</h5>
                        <p>حفظ كتاب الله وتعلم التلاوة الصحيحة في بيئة إيمانية متميزة مع معلمات متخصصات - {{ $activeDour }} دار متاحة</p>
                ...
                <div class="col-sm-6 col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <a href="{{ route('student.register.form', ['type' => 'مركز', 'gender' => 'بنات']) }}" class="program-card">
                ...
                @if($activeRiyaheenBoys > 0)
                <div class="col-sm-6 col-lg-6" data-aos="fade-up" data-aos-delay="300">
                    <a href="{{ route('student.register.form', ['type' => 'برنامج', 'gender' => 'بنين']) }}" class="program-card">
                        <div class="program-icon bg-gradient-riyaheen-boys">
                            <i class="fas fa-child"></i>
                        </div>
                        <h5>برنامج الرياحين - بنين</h5>
                        <p>برنامج تربوي وتعليمي للأطفال لغرس حب القرآن الكريم في نفوسهم منذ الصغر - {{ $activeRiyaheenBoys }} برنامج متاح</p>
                        <div class="program-badges">
                ...
                @if($activeRiyaheenGirls > 0)
                <div class="col-sm-6 col-lg-6" data-aos="fade-up" data-aos-delay="400">
                    <a href="{{ route('student.register.form', ['type' => 'برنامج', 'gender' => 'بنات']) }}" class="program-card">
                        <div class="program-icon bg-gradient-riyaheen-girls">
                            <i class="fas fa-child"></i>
                        </div>
                        <h5>برنامج الرياحين - بنات</h5>
                        <p>برنامج تربوي وتعليمي للطفلات لغرس حب القرآن الكريم في نفوسهن منذ الصغر - {{ $activeRiyaheenGirls }} برنامج متاح</p>
                        <div class="program-badges">
                            <span class="program-badge badge-female"><i class="fas fa-female me-1"></i> بنات</span>
                            <span class="program-badge badge-evening"><i class="fas fa-moon me-1"></i> مسائية فقط</span>
                        </div>
            ...
            <div class="row">
                <div class="col-6 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
                    <div class="stat-box">
                        ...
                        <div class="stat-number" data-target="{{ $stats['centers_count'] }}">{{ $stats['centers_count'] }}</div>
                ...
                <div class="col-6 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
                    <div class="stat-box">
                        ...
                        <div class="stat-number" data-target="{{ $stats['students_count'] }}">{{ $stats['students_count'] }}</div>
                ...
                <div class="col-6 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
                    <div class="stat-box">
                        ...
                        <div class="stat-number" data-target="{{ $stats['buses_count'] }}">{{ $stats['buses_count'] }}</div>
                ...
                <div class="col-6 col-lg-3" data-aos="zoom-in" data-aos-delay="400">
                    <div class="stat-box">
                        ...
                        <div class="stat-number" data-target="{{ $stats['drivers_count'] }}">{{ $stats['drivers_count'] }}</div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="400">
                    <div class="about-card">
                        <img src="{{ asset('images/logo.png') }}" alt="الشعار" class="about-card-logo">
                        <h4>رسالتنا</h4>
    ...
    <section id="contact" class="footer-section">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>© {{ date('Y') }} جمعية القرآن الكريم بالزلفي - جميع الحقوق محفوظة</p>
