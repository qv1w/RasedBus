                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group">
                            <input type="number" name="default_payment_amount" class="form-control" 
                                   value="{{ $settings['default_payment_amount'] }}" step="0.01" min="1" required>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="default_payment_description" class="form-control" 
                               value="{{ $settings['default_payment_description'] }}" required
                    ...
                    <div class="d-flex gap-4">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="auto_payment_enabled" 
                                   value="yes" id="autoYes" {{ $settings['auto_payment_enabled'] == 'yes' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="auto_payment_enabled" 
                                   value="no" id="autoNo" {{ $settings['auto_payment_enabled'] == 'no' ? 'checked' : '' }}>
        ...
        <div class="content-card">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <a href="{{ route('admin.payments.bulk-create') }}" class="quick-link-card">
                ...
                <div class="col-md-4 mb-3">
                    <a href="{{ route('admin.payments.missing') }}" class="quick-link-card">
                ...
                <div class="col-md-4 mb-3">
                    <a href="{{ route('admin.payments.index') }}?status=pending" class="quick-link-card">
