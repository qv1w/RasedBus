...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <div class="content-card text-center">
            ...
            <h4 class="mb-1">{{ $admin->name ?? 'المدير' }}</h4>
            <p class="text-muted mb-3">{{ $admin->email ?? 'admin@example.com' }}</p>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-6 mb-3">
                        <div class="stat-box">
                            ...
                            <h4 class="mb-0">{{ $activityHours }}</h4>
                    ...
                    <div class="col-6 mb-3">
                        <div class="stat-box">
                            ...
                            <h4 class="mb-0">{{ $modificationsCount }}</h4>
        ...
        <div class="content-card mt-4">
            ...
            <div class="activity-timeline">
                ...
                <div class="activity-item">
                    <div class="activity-icon bg-{{ $activity->action_color }}">
                        <i class="fas fa-{{ $activity->action_icon }}"></i>
                    </div>
                    <div class="activity-content">
                        <p class="mb-0">{{ $activity->action_label }}</p>
