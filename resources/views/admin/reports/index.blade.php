...
<div id="report-container">
    ...
    <div class="report-footer">
        <p>تم إنشاء هذا التقرير بتاريخ <strong>{{ now()->format('Y-m-d') }}</strong> الساعة <strong>{{ now()->format('H:i') }}</strong></p>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control bg-dark text-white border-secondary" 
                               placeholder="تقرير شامل - {{ now()->format('Y-m-d') }}"
                               value="تقرير شامل - {{ now()->format('Y-m-d') }}">
