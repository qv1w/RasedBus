...
<div id="printable-report">
    ...
    <div class="print-header">
        <div class="text-center mb-4">
            ...
            <p class="text-muted small">تاريخ التقرير: {{ now()->format('Y-m-d') }} | الوقت: {{ now()->format('H:i') }}</p>
        </div>
        <hr>
    </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card primary">
                <div class="d-flex align-items-center">
                    ...
                    <div class="me-3">
                        <h3 class="mb-0">{{ number_format($studentStats['total']) }}</h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card warning">
                <div class="d-flex align-items-center">
                    ...
                    <div class="me-3">
                        <h3 class="mb-0">{{ number_format($busStats['total']) }}</h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card info">
                <div class="d-flex align-items-center">
                    ...
                    <div class="me-3">
                        <h3 class="mb-0">{{ number_format($driverStats['total']) }}</h3>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stats-card success">
                <div class="d-flex align-items-center">
                    ...
                    <div class="me-3">
                        <h3 class="mb-0">{{ number_format($paymentStats['total_paid']) }}</h3>
                    ...
                    <table class="table table-sm">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end fw-bold">{{ number_format($studentStats['approved']) }}</td>
                                <td class="text-end text-muted">{{ $studentStats['total'] > 0 ? round($studentStats['approved'] / $studentStats['total'] * 100, 1) : 0 }}%</td>
                            </tr>
                            <tr>
                                <td><span class="badge bg-warning">قيد المراجعة</span></td>
                                <td class="text-end fw-bold">{{ number_format($studentStats['pending']) }}</td>
                                <td class="text-end text-muted">{{ $studentStats['total'] > 0 ? round($studentStats['pending'] / $studentStats['total'] * 100, 1) : 0 }}%</td>
                            </tr>
                            <tr>
                                <td><span class="badge bg-danger">مرفوض</span></td>
                                <td class="text-end fw-bold">{{ number_format($studentStats['rejected']) }}</td>
                                <td class="text-end text-muted">{{ $studentStats['total'] > 0 ? round($studentStats['rejected'] / $studentStats['total'] * 100, 1) : 0 }}%</td>
                            </tr>
                            <tr>
                                <td><span class="badge bg-secondary">معلق</span></td>
                                <td class="text-end fw-bold">{{ number_format($studentStats['suspended']) }}</td>
                                <td class="text-end text-muted">{{ $studentStats['total'] > 0 ? round($studentStats['suspended'] / $studentStats['total'] * 100, 1) : 0 }}%</td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr class="table-dark">
                                <td><strong>الإجمالي</strong></td>
                                <td class="text-end fw-bold">{{ number_format($studentStats['total']) }}</td>
                ...
                <div class="row text-center mb-3">
                    <div class="col-6">
                        <div class="p-3 rounded stat-box male">
                            ...
                            <h4 class="mb-0">{{ number_format($studentStats['male']) }}</h4>
                            <small>ذكور</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 rounded stat-box female">
                            ...
                            <h4 class="mb-0">{{ number_format($studentStats['female']) }}</h4>
                            <small>إناث</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <div class="p-3 rounded stat-box morning">
                            ...
                            <h4 class="mb-0">{{ number_format($studentStats['morning']) }}</h4>
                            <small>صباحية</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 rounded stat-box evening">
                            ...
                            <h4 class="mb-0">{{ number_format($studentStats['evening']) }}</h4>
                            <small>مسائية</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-4">
                        <div class="p-3 rounded stat-box dour">
                            ...
                            <h4 class="mb-0">{{ number_format($studentStats['dour']) }}</h4>
                            <small>الدور</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-3 rounded stat-box markaz">
                            ...
                            <h4 class="mb-0">{{ number_format($studentStats['markaz']) }}</h4>
                            <small>المركز</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-3 rounded stat-box riyaheen">
                            ...
                            <h4 class="mb-0">{{ number_format($studentStats['riyaheen']) }}</h4>
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <div class="p-3 rounded stat-box success-light">
                            <h4 class="mb-0">{{ number_format($studentStats['with_bus']) }}</h4>
                            <small>لديهم باص</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 rounded stat-box danger-light">
                            <h4 class="mb-0">{{ number_format($studentStats['without_bus']) }}</h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="row text-center">
                    <div class="col-4">
                        <div class="p-3 rounded stat-box success-light">
                            <h4 class="mb-0 text-success">{{ $busStats['active'] }}</h4>
                            <small>نشط</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-3 rounded stat-box warning-light">
                            <h4 class="mb-0 text-warning">{{ $busStats['maintenance'] }}</h4>
                            <small>صيانة</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-3 rounded stat-box danger-light">
                            <h4 class="mb-0 text-danger">{{ $busStats['inactive'] }}</h4>
                            <small>متوقف</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <div class="p-3 rounded stat-box success-light">
                            <h4 class="mb-0">{{ $busStats['with_driver'] }}</h4>
                            <small>مع سائق</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 rounded stat-box danger-light">
                            <h4 class="mb-0">{{ $busStats['without_driver'] }}</h4>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="capacity-stats">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong>{{ number_format($busStats['total_capacity']) }}</strong>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>المقاعد المشغولة:</span>
                        <strong class="text-success">{{ number_format($busStats['occupied_seats']) }}</strong>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>المقاعد المتاحة:</span>
                        <strong class="text-info">{{ number_format($busStats['available_seats']) }}</strong>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between mb-2">
                        <span>نسبة الإشغال:</span>
                        <strong class="text-warning">{{ $busStats['occupancy_rate'] }}%</strong>
                    </div>
                    <div class="progress" style="height: 20px;">
                        <div class="progress-bar bg-{{ $busStats['occupancy_rate'] >= 90 ? 'danger' : ($busStats['occupancy_rate'] >= 70 ? 'warning' : 'success') }}" 
                             style="width: {{ $busStats['occupancy_rate'] }}%">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="quick-stats">
                    <div class="quick-stat-item">
                        ...
                        <strong>{{ $busStats['total'] > 0 ? round($busStats['total_capacity'] / $busStats['total']) : 0 }} راكب</strong>
                    </div>
                    <div class="quick-stat-item">
                        <span>متوسط الركاب للباص:</span>
                        <strong>{{ $busStats['total'] > 0 ? round($busStats['occupied_seats'] / $busStats['total']) : 0 }} راكب</strong>
                    </div>
                    <div class="quick-stat-item">
                        <span>باصات ممتلئة (90%+):</span>
                        <strong>{{ $busesDetails->where('occupancy_rate', '>=', 90)->count() }}</strong>
                    </div>
                    <div class="quick-stat-item">
                        <span>باصات فارغة (0%):</span>
                        <strong>{{ $busesDetails->where('current_students', 0)->count() }}</strong>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 mb-4">
                ...
                <div class="row text-center">
                    <div class="col-4">
                        <div class="p-3 rounded stat-box success-light">
                            <h4 class="mb-0 text-success">{{ $driverStats['active'] }}</h4>
                            <small>نشط</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-3 rounded stat-box warning-light">
                            <h4 class="mb-0 text-warning">{{ $driverStats['on_leave'] }}</h4>
                            <small>إجازة</small>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="p-3 rounded stat-box danger-light">
                            <h4 class="mb-0 text-danger">{{ $driverStats['inactive'] }}</h4>
                            <small>غير نشط</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <div class="p-3 rounded stat-box success-light">
                            <h4 class="mb-0">{{ $driverStats['with_bus'] }}</h4>
                            <small>مخصص لباص</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 rounded stat-box info-light">
                            <h4 class="mb-0">{{ $driverStats['without_bus'] }}</h4>
                            <small>متاح</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="quick-stats">
                    <div class="quick-stat-item">
                        ...
                        <strong>{{ number_format($driverStats['total_salary']) }} ر.س</strong>
                    </div>
                    <div class="quick-stat-item">
                        <span>متوسط الخبرة:</span>
                        <strong>{{ $driverStats['avg_experience'] }} سنة</strong>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="payment-summary">
                    <div class="payment-item total">
                        <div class="d-flex justify-content-between">
                            ...
                            <strong>{{ number_format($paymentStats['total_required'], 2) }} ر.س</strong>
                        </div>
                    </div>
                    <div class="payment-item paid">
                        <div class="d-flex justify-content-between">
                            <span>إجمالي المبالغ المحصّلة:</span>
                            <strong class="text-success">{{ number_format($paymentStats['total_paid'], 2) }} ر.س</strong>
                        </div>
                    </div>
                    <div class="payment-item pending-amount">
                        <div class="d-flex justify-content-between">
                            <span>مبالغ قيد المراجعة:</span>
                            <strong class="text-warning">{{ number_format($paymentStats['total_pending'], 2) }} ر.س</strong>
                        </div>
                    </div>
                    <div class="payment-item remaining">
                        <div class="d-flex justify-content-between">
                            <span>المبالغ المتبقية:</span>
                            <strong class="text-danger">{{ number_format($paymentStats['total_remaining'], 2) }} ر.س</strong>
                        </div>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between mb-2">
                        <span>نسبة التحصيل:</span>
                        <strong class="text-primary">{{ $paymentStats['collection_rate'] }}%</strong>
                    </div>
                    <div class="progress" style="height: 25px;">
                        <div class="progress-bar bg-success" style="width: {{ $paymentStats['collection_rate'] }}%">
                            {{ $paymentStats['collection_rate'] }}% محصّل
                        </div>
                        <div class="progress-bar bg-danger" style="width: {{ 100 - $paymentStats['collection_rate'] }}%">
                            {{ round(100 - $paymentStats['collection_rate'], 1) }}% متبقي
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-sm">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end fw-bold">{{ number_format($paymentStats['approved_payments']) }}</td>
                            </tr>
                            <tr>
                                <td><span class="badge bg-warning">قيد المراجعة</span></td>
                                <td class="text-end fw-bold">{{ number_format($paymentStats['pending_payments']) }}</td>
                            </tr>
                            <tr>
                                <td><span class="badge bg-primary">بانتظار الإيصال</span></td>
                                <td class="text-end fw-bold">{{ number_format($paymentStats['awaiting_receipt']) }}</td>
                            </tr>
                            <tr>
                                <td><span class="badge bg-danger">مرفوضة</span></td>
                                <td class="text-end fw-bold">{{ number_format($paymentStats['rejected_payments']) }}</td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr class="table-dark">
                                <td><strong>إجمالي الدفعات</strong></td>
                                <td class="text-end fw-bold">{{ number_format($paymentStats['total_payments']) }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        <div class="row mb-4">
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="text-center p-3 rounded stat-box dour">
                    <i class="fas fa-mosque fa-2x mb-2"></i>
                    <h4 class="mb-0">{{ $centerStats['dour'] }}</h4>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="text-center p-3 rounded stat-box markaz">
                    <i class="fas fa-graduation-cap fa-2x mb-2"></i>
                    <h4 class="mb-0">{{ $centerStats['markaz'] }}</h4>
                    <small>المراكز</small>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="text-center p-3 rounded stat-box riyaheen">
                    <i class="fas fa-seedling fa-2x mb-2"></i>
                    <h4 class="mb-0">{{ $centerStats['riyaheen'] }}</h4>
                    <small>الرياحين</small>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="text-center p-3 rounded stat-box info-light">
                    ...
                    <h4 class="mb-0">{{ $centerStats['total'] }}</h4>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endphp
                            <span class="badge bg-{{ $typeClass }}">{{ $center['type'] }}</span>
                        </td>
                        <td>{{ $center['gender'] }}</td>
                        <td><strong>{{ $center['students_count'] }}</strong></td>
                        <td class="text-success">{{ $center['approved_students'] }}</td>
                        <td class="text-warning">{{ $center['pending_students'] }}</td>
                        <td>{{ $center['morning_students'] }}</td>
                        <td>{{ $center['evening_students'] }}</td>
                        <td>{{ $center['buses_count'] }}</td>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="progress flex-grow-1 me-2" style="height: 8px; width: 60px;">
                                    <div class="progress-bar bg-{{ $center['occupancy_rate'] >= 90 ? 'danger' : ($center['occupancy_rate'] >= 70 ? 'warning' : 'success') }}" 
                                         style="width: {{ $center['occupancy_rate'] }}%"></div>
                                </div>
                                <small>{{ $center['occupancy_rate'] }}%</small>
                            </div>
                        </td>
                    </tr>
                    @endforeach
            ...
            <table class="table table-sm table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($center['total_required'], 2) }}</td>
                        <td class="text-success">{{ number_format($center['total_paid'], 2) }}</td>
                        <td class="text-danger">{{ number_format($center['total_remaining'], 2) }}</td>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="progress flex-grow-1 me-2" style="height: 8px; width: 80px;">
                                    <div class="progress-bar bg-success" style="width: {{ $center['collection_rate'] }}%"></div>
                                </div>
                                <small>{{ $center['collection_rate'] }}%</small>
                            </div>
                        </td>
                    </tr>
                    @endforeach
                ...
                <tfoot class="table-secondary">
                    <tr>
                        ...
                        <td><strong>{{ $paymentsByCenter->sum('students_count') }}</strong></td>
                        <td><strong>{{ number_format($paymentsByCenter->sum('total_required'), 2) }}</strong></td>
                        <td class="text-success"><strong>{{ number_format($paymentsByCenter->sum('total_paid'), 2) }}</strong></td>
                        <td class="text-danger"><strong>{{ number_format($paymentsByCenter->sum('total_remaining'), 2) }}</strong></td>
                        <td><strong>{{ $paymentStats['collection_rate'] }}%</strong></td>
                    </tr>
                </tfoot>
            </table>
        </div>
            ...
            <table class="table table-sm table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $bus['capacity'] }}</td>
                        <td class="text-success">{{ $bus['current_students'] }}</td>
                        <td class="text-info">{{ $bus['available_seats'] }}</td>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <small>{{ $bus['occupancy_rate'] }}%</small>
                            </div>
                        </td>
                        <td>
                            @php
                            ...
                            @endphp
                            <span class="badge bg-{{ $statusClass }}">{{ $bus['status_text'] }}</span>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="table-responsive">
            <table class="table table-sm table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><small>{{ $driver['driver_id'] }}</small></td>
                        <td><strong>{{ $driver['name'] }}</strong></td>
                        <td dir="ltr">{{ $driver['mobile'] }}</td>
                        <td>{{ $driver['license_number'] }}</td>
                        <td>{{ $driver['experience_years'] }} سنة</td>
                        <td>{{ $driver['center_name'] }}</td>
                        <td>{{ $driver['bus_number'] }}</td>
                        <td>{{ number_format($driver['salary']) }}</td>
                        <td>
                            @php
            ...
            <div class="col-lg-6">
                ...
                <div class="quick-stats">
                    <div class="quick-stat-item">
                        ...
                        <strong>{{ number_format($adminStats['total_activities']) }}</strong>
                    </div>
                    <div class="quick-stat-item">
                        <span>أنشطة اليوم:</span>
                        <strong>{{ number_format($adminStats['today_activities']) }}</strong>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $student->status_color }}">{{ $student->status_name }}</span>
                                </td>
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ Str::limit($payment->student->name ?? '-', 15) }}</td>
                                <td>{{ number_format($payment->amount) }}</td>
                                <td>
                                    <span class="badge bg-{{ $payment->status_color }}">{{ $payment->status_text }}</span>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="print-footer">
        ...
        <div class="row text-center text-muted small">
            ...
            <div class="col-4">
                <p class="mb-0">{{ now()->format('Y-m-d H:i:s') }}</p>
            </div>
            <div class="col-4">
